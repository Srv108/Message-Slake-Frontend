...
export const ChannelDetailsDrawer = ({ open, channel, onClose }) => {
    ...
    return (
        <>
            ...
            <div className={`absolute inset-0 bg-slack-medium shadow-2xl z-50 border-l border-slate-700 transform transition-transform duration-500 ease-out ${
                open ? 'translate-x-0' : 'translate-x-full'
            }`}>
                {/* Header */}
                <div className='flex items-center justify-between px-4 h-[50px] border-b border-slate-700'>
                    <h2 className='font-semibold text-lg text-slate-100'>Channel Details</h2>
                    <button
                        onClick={onClose}
                    ...
                    <div className='py-6'>
                        ...
                        <div className='px-4 mt-6 pt-6 border-t border-slate-700'>
                            ...
                            <div className='space-y-3 text-xs text-slate-400'>
                                <div className='flex justify-between items-center py-2 px-3 bg-slate-800/30 rounded'>
                                    <span>Channel ID:</span>
                                    <span className='text-slate-300 font-mono text-[10px]'>{channel?._id}</span>
                                </div>
                                <div className='flex justify-between items-center py-2 px-3 bg-slate-800/30 rounded'>
                                    <span>Created:</span>
